      ...
      <div class="nav-links" :class="{ 'mobile-open': isMobileMenuOpen }">
        ...
        <div class="nav-contact-info">
          ...
          <div class="nav-social">
            <a href="https://www.instagram.com/seven_dates.uz/" target="_blank" class="nav-social-link" title="Instagram">
            ...
            <a href="https://t.me/sevendatesuz" target="_blank" class="nav-social-link" title="Telegram">
              <svg class="nav-icon" viewBox="0 0 24 24" fill="currentColor">
